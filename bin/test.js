var yamlParser = require("../bin/parser.js");
...
if (JSON.stringify(json.toNormal()) == JSON.stringify({ string: "String", object: { subString: "SubString", subObject: { subSubString: "SubSubString" }, subArray: ["Sub1.", "Sub2.", "Sub3."] }, array: ["1.", "2.", "3."] }))
