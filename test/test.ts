...
if (JSON.stringify(json.toJson()) == JSON.stringify({ string: "String", object: { subString: "SubString", subObject: { subSubString: "SubSubString" }, subArray: ["Sub1.", "Sub2.", "Sub3."] }, array: ["1.", "2.", "3."] })) console.log("toJson Working")